package org.hign.platform.wanderlog.iam.interfaces.acl;
...
import org.hign.platform.wanderlog.iam.domain.services.UserQueryService;
...
public class IamContextFacade {
     ...
     * @return The id of the created user.
     */
    public Integer createUser(String username, String password, List<String> roleNames) {
     ...
     */
    public String fetchUsernameByUserId(Integer userId) {
